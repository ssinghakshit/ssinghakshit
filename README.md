...
My work spans backend APIs, cloud deployments, and automation. I prefer minimal tooling, clean code, and systems that scale. Most of my projects use Node.js, PostgreSQL, Docker, and GitHub Actions.

---

### 🛠️ Tech I Use

Node.js • TypeScript • Express • PostgreSQL • MongoDB  
Docker • Supabase • GitHub Actions • Redis • Nginx • AWS

---

### 🔎 Interests

- System design and distributed backend architectures  
- Developer tooling and workflow automation  
- Cloud-native apps and CI/CD pipelines
